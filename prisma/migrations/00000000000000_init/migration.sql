...
-- AddForeignKey
ALTER TABLE "leads" ADD CONSTRAINT "leads_import_job_id_fkey" FOREIGN KEY ("import_job_id") REFERENCES "import_job_status"("id") ON DELETE SET NULL ON UPDATE CASCADE;
