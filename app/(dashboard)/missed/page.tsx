  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex items-start gap-3">
        <div className="w-11 h-11 rounded-xl grid place-items-center bg-amber-50 text-amber-600 shrink-0">
      ...
      <div className="rounded-2xl border border-slate-200/70 bg-white overflow-hidden">
        <div className="px-6 pt-5 pb-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5 min-w-0">
            <h2 className="text-[15px] font-semibold text-ink">High-value missed opportunities</h2>
            {total > 0 && (
              <span className="inline-flex items-center justify-center text-[10px] font-bold bg-rose-600 text-white rounded-full min-w-[20px] h-[20px] px-2">
                {total}
              </span>
            )}
          </div>
          {!isLoading && sortedLeads.length > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1.5 h-8 px-3.5 rounded-lg shrink-0
        ...
        {/* headers */}
        <div className="grid grid-cols-[1fr_120px_104px_118px_48px] gap-4 px-6 py-2 text-[10px] font-bold uppercase tracking-[0.14em] text-ink-soft border-b border-slate-100">
          <span>Lead</span>
        ...
        {!isLoading && total === 0 && !error && (
          <div className="px-6 py-12 text-center">
            <div className="w-12 h-12 rounded-lg grid place-items-center bg-emerald-50 text-emerald-600 mx-auto mb-3">
        ...
        {!isLoading && sortedLeads.length > 0 && (
          <>
              ...
              {sortedLeads.map((lead) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold w-fit border bg-rose-50 text-rose-700 border-rose-200">
            ...
            {/* Total row */}
            <div className="grid grid-cols-[1fr_120px_104px_118px_48px] gap-4 px-6 py-4 items-center border-t border-slate-100 bg-rose-50">
      ...
      {reassignTarget && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/55 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-2xl border border-slate-200/70 bg-white overflow-hidden">
            ...
            <div className="px-5 py-4 space-y-3">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => { setReassignTarget(null); setSelectedRepId("") }}
                  className="flex-1 h-10 rounded-lg border border-slate-200 bg-white text-[13px] font-semibold text-slate-600 transition-all"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 h-10 rounded-lg bg-sky-600 hover:bg-sky-700 text-white text-[13px] font-semibold disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                >
